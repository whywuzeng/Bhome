...
import net.qiujuer.italker.common.adapter.animation.AlphaInAnimation;
import net.qiujuer.italker.common.adapter.animation.BaseAnimation;
import net.qiujuer.italker.common.adapter.animation.ScaleInAnimation;
import net.qiujuer.italker.common.adapter.animation.SlideInBottomAnimation;
import net.qiujuer.italker.common.adapter.animation.SlideInLeftAnimation;
import net.qiujuer.italker.common.adapter.animation.SlideInRightAnimation;
import net.qiujuer.italker.common.adapter.entity.IExpandable;
import net.qiujuer.italker.common.adapter.loadmore.LoadMoreView;
import net.qiujuer.italker.common.adapter.loadmore.SimpleLoadMoreView;
import net.qiujuer.italker.common.adapter.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    public K onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        onButterKnifeBind(baseViewHolder ,viewType);
        return baseViewHolder;

    }

    protected abstract void onButterKnifeBind(K baseViewHolder, int viewType);
