package com.system.bhouse.api.manager;
...
import com.system.bhouse.base.BaseSchedulerTransformer;
        ...
        if (sOkHttpClient == null) {
            synchronized (RetrofitManager.class) {
                if (sOkHttpClient == null) {
                    ...
                    // 指定缓存路径,缓存大小100Mb
                    Cache cache = new Cache(new File(App.getContextApp().getCacheDir(), "HttpCache"), 1024 * 1024 * 100);
