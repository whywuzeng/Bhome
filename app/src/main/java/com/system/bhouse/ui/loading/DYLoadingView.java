...
public class DYLoadingView extends View {
    ...
    private static final int PAUSE_DUARTION = 200;
    ...
    private int color1=Color.RED;//初始左小球颜色
    private int color2=Color.BLUE;//初始右小球颜色
    private int mixColor=Color.BLACK;//两小球重叠处的颜色
