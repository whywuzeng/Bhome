package com.system.bhouse.ui.widget;
 ...
 * ClassName: com.system.bhouse.textapplication.widget.refresh
...
public class RefreshLayout extends RelativeLayout {
    ...
    // 头部
    //    private UcRefreshHead mUcRefreshHead;
        ...
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mControlHeadAnimator != null && mControlHeadAnimator
                        .isRunning() || mState == HIDE || mUcRefreshHead
                ...
                mControlHeadAnimator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        if (mState == RELEASE_TO_REFRESH && mUcRefreshHead.isReadyLoad()) {
                            // 释放刷新，头部开启刷新动画
