...
public class AttachmentFileObject  implements Serializable {
    ...
    public void setAttachmentFileObject(String header,String footer,boolean isHeader,boolean isFooter,JSONObject json) {
...
//    }
    ...
    public static AttachmentFileObject parseFileObject(String header,String footer,boolean isHeader,boolean isFooter,AttachmentFolderObject folderObject) {
