 ...
 * UpdateDate:
 */
public class ConfirmationContentItemSection extends Section {
    ...
    public void setSearchHistroyBeans(ArrayList<ConfirmationReceBean> searchHistroyBeans) {
        this.searchHistroyBeans = searchHistroyBeans;
    }

    private ArrayList<ConfirmationReceBean> searchHistroyBeans = new ArrayList<>();


    public ConfirmationContentItemSection(ArrayList<ConfirmationReceBean> searchHistroyBeans, StatusBean mStatusBean) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            holder1.tvWuliao.setText(searchHistroyBeans.get(position).container);
            holder1.WuliaoUnit.setText(searchHistroyBeans.get(position).Qrcode);
            ...
            holder1.tvUnit.setText(searchHistroyBeans.get(position).measure);
            holder1.tvRequireNum.setText(searchHistroyBeans.get(position).requireAmount+"");
            holder1.tvReceiptAmount.setText(searchHistroyBeans.get(position).amount+"");
            holder1.tvProjectName.setText(searchHistroyBeans.get(position).projectName);
            holder1.tvDong.setText(searchHistroyBeans.get(position).dong);
            holder1.tvCengAmount.setText(searchHistroyBeans.get(position).ceng);



            TextView[] titleContent = {holder1.tvWuliaoId, holder1.tvWuliaoUnitId, holder1.tvCountMeasureId, holder1.tvCountAmountId, holder1.tvCountId,holder1.tvUnitId,holder1.tvRequireNumId,holder1.tvReceiptAmountId,holder1.tvProjectNameId,holder1.tvDongId,holder1.tvCengAmountId};
