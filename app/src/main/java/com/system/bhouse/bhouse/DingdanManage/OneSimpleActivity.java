 ...
 * UpdateDate:
 */
public class OneSimpleActivity extends BaseActivity {
    ...
    protected String getToolbarTitle() {
        ...
        return this.getResources().getString(R.string.gongchangpaichan);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initdate();
        initEvent();
        topfanhuititle_textview_zhende.setText(R.string.gongchangpaichan);
    }
    ...
    private void initdate() {
        String[] stringArray = this.getResources().getStringArray(R.array.yanshoushengqing);
        ...
        for (int i = 0; i < stringArray.length; i++) {
            ...
            if (i % 2 == 0) {
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.OneSimpleActivityIndex + "", false);
            }
            else {
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.OneSimpleActivityIndex + "", true);
