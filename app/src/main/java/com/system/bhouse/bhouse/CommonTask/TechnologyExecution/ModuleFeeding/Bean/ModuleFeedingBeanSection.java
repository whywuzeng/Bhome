...
public class ModuleFeedingBeanSection extends HeaderAndFooterSectionEntity<ModuleFeedingBean> {

    private boolean isMore;

    public ModuleFeedingBeanSection(boolean isHeader, String header , boolean isMore, boolean isFooter , String footer) {
        super(isHeader, header,isFooter,footer);
        this.isMore=isMore;
    }

    public ModuleFeedingBeanSection(ModuleFeedingBean item)
    {
        super(item);
        /**
         * delete禁止显示
