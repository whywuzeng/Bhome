...
public class MaintenanceWarehouseBean extends TechnologyBaseBean implements Parcelable {
    ...
    public MaintenanceWarehouseBean() {
    }

    protected MaintenanceWarehouseBean(Parcel in) {
    ...
    public static final Parcelable.Creator<MaintenanceWarehouseBean> CREATOR = new Parcelable.Creator<MaintenanceWarehouseBean>() {
        @Override
        public MaintenanceWarehouseBean createFromParcel(Parcel source) {
            return new MaintenanceWarehouseBean(source);
        }

        @Override
        public MaintenanceWarehouseBean[] newArray(int size) {
            return new MaintenanceWarehouseBean[size];
        }
    };
}
