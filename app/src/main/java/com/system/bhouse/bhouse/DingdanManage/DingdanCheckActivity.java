 ...
 * UpdateDate:
 */
public class DingdanCheckActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initdate();
        initEvent();
        topfanhuititle_textview_zhende.setText(R.string.dangdanyanshou);
    }

    @Override
    protected String getToolbarTitle() {

        return this.getResources().getString(R.string.dangdanyanshou);
    }
    ...
    private void initEvent() {
        ...
        fanhui_lin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                try {
                    AppManager.getAppManager().finishActivity(DingdanCheckActivity.class);
                } catch (Exception e) {
                    e.printStackTrace();
                    if (!DingdanCheckActivity.this.isFinishing()) {
                        DingdanCheckActivity.this.finish();
                    }
                }
            }
        });
    ...
    private void initdate() {
        String[] stringArray = this.getResources().getStringArray(R.array.dingdanyanshou);
        ...
        for (int i = 0; i < stringArray.length; i++) {
            ...
            if(i%2==0){
                 fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.DingdanCheckActivityIndex + "",false);
            }else{
                 fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.DingdanCheckActivityIndex + "",true);
