package com.system.bhouse.bhouse.CommonTask.TechnologyExecution.MaintenanceOutWarehouse;
...
public class MaintenanceOutWarehouseContentMessageActivity extends BaseContentMessageActivity implements  GroupItem.onChildItemClickListener, onMutiDataSetListener ,BaseQuickAdapter.OnItemChildClickListener,BaseContentMessageActivity.SetOnAddItemClickListener {
...
//            BottomAction();
    ...
    private void TopListViewInit() {
        ...
        ArrayList<MaintenanceOutWarehouseContentMessageActivity.KeyType> keyTypes = new ArrayList<>();
        MaintenanceOutWarehouseContentMessageActivity.KeyType keyType = null;
        for (int i = 0; i < Const.LETTERS.length; i++) {
            keyType = new MaintenanceOutWarehouseContentMessageActivity.KeyType();
     ...
     * @return
     */
    protected ArrayList<SortChildItem.ViewModel> makeChlidData(MaintenanceOutWarehouseContentMessageActivity.KeyType data, StatusBean mStatus) {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (viewEditText.getText() != null) {
                    ...
                    if (TextUtils.isEmpty(text)) {
                        T.showfunShort(MaintenanceOutWarehouseContentMessageActivity.this, "备注不能为空");
                    }
                    else {
...
//
//            ClearAssignMentSectionArrayList();
//            maintenanceOutWarehouseSectionAdapter.notifyItemChanged(extraPosition);
        }
    }
    ...
    private void getStaffData(int position) {
        ApiWebService.Get_Production_order_Per_Member_Json(this, new ApiWebService.SuccessCall() {
            ...
            public void SuccessBack(String result) {
                ...
                CommonPickerActivity_.intent(MaintenanceOutWarehouseContentMessageActivity.this).title("职员信息").bProBOMs(bProBOMs).Position(position).LayoutID(R.layout.commonpicker_item).startForResult(RESULT_SORTITEM_SELECTPROJECT);
...
//        }, orderId, componentQr, comTaskBeans.get(0).ID);
    ...
    private void testData() {
        comTaskBeans.clear();
        ApiWebService.Get_Production_order_yhy_Out_byidr_Json_poidprid_QR_Code(this, new ApiWebService.SuccessCall() {
            @Override
            public void SuccessBack(String result) {
...
//        }
        ...
        if (mStatus.isNewStatus()) {
            ...
            ApiWebService.Get_Production_order_Trolley_Add(this, new ApiWebService.SuccessCall() {
                @Override
                public void SuccessBack(String result) {
                    T.showShort(MaintenanceOutWarehouseContentMessageActivity.this, result);
