...
public class ReturnRequireListFragment extends BaseCommonListFragment<ReturnRequireLoadingAdapter,ConfirmationReceBean> implements ReturnRequireLoadingAdapter.onItemClickListener {

    ReturnRequireLoadingAdapter mAdapter;
    ...
    {
        initRefreshLayout();
        mAdapter = new ReturnRequireLoadingAdapter(mData);
    ...
    protected void loadData() {
        if (mUpdateAll) {
            mUpdateAll = false;
            ApiWebService.Get_Sale_Order_Car_qr_rn_Json(getActivity(), new ApiWebService.SuccessCall() {
