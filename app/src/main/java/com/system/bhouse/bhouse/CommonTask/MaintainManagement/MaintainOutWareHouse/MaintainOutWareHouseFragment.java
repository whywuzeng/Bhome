...
public class MaintainOutWareHouseFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        MaintainOutWareHouseListFragment confirmationReceiptListFragment = new MaintainOutWareHouseListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Production_order_yhy_Outpo_Number(getActivity(), new ApiWebService.SuccessCall() {
            @Override
            public void SuccessBack(String result) {
                ...
                MaintainOutWareHouseContentMessageActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
            }
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            MaintainOutWareHouseListFragment fragment = (MaintainOutWareHouseListFragment) super.instantiateItem(container, position);
            fragment.setParent(MaintainOutWareHouseFragment.this);
            return fragment;
        }
    }
}
