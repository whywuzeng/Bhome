...
public class TransportSendGoodsLoadingAdapter extends LoadingAdapter<TransportSendGoodsBean> {

    private ArrayList<TransportSendGoodsBean> mComTaskBeans = new ArrayList<>();

    public TransportSendGoodsLoadingAdapter(ArrayList<TransportSendGoodsBean> mComTaskBeans) {
