...
public class FinishedStorageLoadingAdapter extends LoadingAdapter<FinishedStorageBean> {

    private final String[] TitlestringArray;
    private ArrayList<FinishedStorageBean> mComTaskBeans = new ArrayList<>();

    public FinishedStorageLoadingAdapter(ArrayList<FinishedStorageBean> mComTaskBeans) {
        this.mComTaskBeans = mComTaskBeans;
        TitlestringArray = App.getContextApp().getResources().getStringArray(R.array.finished_storage_order);
    }
