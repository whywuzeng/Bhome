...
/**
 * 顾修忠-guxiuzhong@youku.com/gfj19900401@163.com
...
//    private ViewPager mViewPager;
    ...
    public StickyNavLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        a.recycle();
        defautTopHeight = MeasureUtil.dip2px(context, 200);
...
//        mViewPager = (ViewPager) view;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        topParams.height = /*mTopViewMaxHeight*/topHeight==0? defautTopHeight :topHeight;
...
//                }
                    ...
                    if (!isInControl && c != null && c.getTop() == 0 /*android.support.v4.view.ViewCompat.canScrollVertically(rv, -1)*/ && isTopHidden
                            && dy > 0) {
                        isInControl = true;
                        ev.setAction(MotionEvent.ACTION_CANCEL);
                        MotionEvent ev2 = MotionEvent.obtain(ev);
...
//                    else if (mInnerScrollView instanceof GridViewWithHeaderAndFooter) {
//                        GridViewWithHeaderAndFooter gv = (GridViewWithHeaderAndFooter) mInnerScrollView;
//                        View c = gv.getChildAt(gv.getFirstVisiblePosition());
//                        if (!isTopHidden
//                                || (c != null && c.getTop() == 0 && isTopHidden && dy > 0)) {
//                            initVelocityTrackerIfNotExists();
...
//                    }
                        ...
                        View c = rv.getChildAt(0);
                        if (!isTopHidden || (c != null && c.getTop() == 0 /*!android.support.v4.view.ViewCompat.canScrollVertically(rv, -1)*/ && isTopHidden && dy > 0)) {
                            initVelocityTrackerIfNotExists();
                            mVelocityTracker.addMovement(ev);
                            mLastY = y;
                            return true;
