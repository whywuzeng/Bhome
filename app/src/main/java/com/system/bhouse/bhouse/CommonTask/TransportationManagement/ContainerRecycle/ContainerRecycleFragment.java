...
public class ContainerRecycleFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        ContainerRecycleListFragment confirmationReceiptListFragment = new ContainerRecycleListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Sale_Order_Car_Container_so_Number(getActivity(), new ApiWebService.SuccessCall() {
            ...
            public void SuccessBack(String result) {
                ...
                ContainerRecycleContentMessageActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
            }
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ContainerRecycleListFragment fragment = (ContainerRecycleListFragment) super.instantiateItem(container, position);
            fragment.setParent(ContainerRecycleFragment.this);
            return fragment;
        }
    }
}
