...
public class LoadingCarOrderLoadingAdapter extends LoadingAdapter<LoadingCarBean> {

    private ArrayList<LoadingCarBean> mComTaskBeans = new ArrayList<>();

    public LoadingCarOrderLoadingAdapter(ArrayList<LoadingCarBean> mComTaskBeans) {
