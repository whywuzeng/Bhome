 ...
 * Fuction: 订单查询 订单合同录入  订单明细录入 3这个adapter的设置
 * UpdateUser:
 * UpdateDate:
 */
public class DingManagerStaggeredAdapter extends RecyclerView.Adapter<DingManagerStaggeredAdapter.MyViewHolder> {
        ...
        private int[] ints = {R.drawable.hetongluru, R.drawable.dingdanchaxun, R.drawable.dingdanchaxun};
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            MyViewHolder holder = new MyViewHolder(mInflater.inflate(
                    R.layout.item_dingdanmanage_mian, parent, false));
            return holder;
        }
        ...
        public void onBindViewHolder(final MyViewHolder holder, final int position) {
            ...
            holder.fram.setBackgroundResource(R.drawable.item_bg_sale_lan_new);
            // 如果设置了回调，则设置点击事件
