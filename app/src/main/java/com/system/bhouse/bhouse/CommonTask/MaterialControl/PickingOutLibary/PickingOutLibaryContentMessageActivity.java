...
public class PickingOutLibaryContentMessageActivity extends BaseContentMessageActivity implements PickingOutLibaryContentItemSection.OnItemClickListener, GroupItem.onChildItemClickListener, onMutiDataSetListener {
    ...
    private void TopListViewInit() {
        ...
        if (ValueUtils.IsFirstValueExist(comTaskBeans)) {
            ...
            comTaskBean1=new PickingOutBean();
