...
public class SimpleTreeAdapter extends TreeListViewAdapter
{
    ...
    public View getConvertView(final Node node , int position, View convertView, ViewGroup parent)
    {
       ...
       final ViewHolder viewHolder ;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.treedemo_list_item, parent, false);
    ...
    View.OnClickListener  clickListener=  new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mOnCbClick!=null) {
                    mOnCbClick.CbClick(node);
                }
            }
        };

        viewHolder.cb.setOnClickListener(clickListener);


        viewHolder.label.setOnClickListener(clickListener);
    ...
    private  static OnCbClick mOnCbClick;

    public void setmOnCbClick(OnCbClick mOnCbClick) {
        this.mOnCbClick = mOnCbClick;
    }

    public interface OnCbClick{
       void CbClick(Node node);
    }
