...
public class TransportSendGoodsContentMessageActivity extends BaseContentMessageActivity implements TransportSendGoodsContentItemSection.OnItemClickListener, GroupItem.onChildItemClickListener, LabelNumPickerDialog.OnDateSetListener {
...
//    status = "审核"
    ...
    private void TopListViewInit() {
        ...
        if (ValueUtils.IsFirstValueExist(comTaskBeans)) {
            ...
            comTaskBean1=new TransportSendGoodsBean();
...
//    }
    ...
    private void testData() {
        ...
        ApiWebService.Get_Sale_Order_CarView_Json(this, new ApiWebService.SuccessCall() {
            @Override
            public void SuccessBack(String result) {
                ArrayList<TransportSendGoodsBean> tomTaskBeans = App.getAppGson().fromJson(result, new TypeToken<List<TransportSendGoodsBean>>() {}.getType());
