...
public class ComponentTakeOffBean extends TechnologyBaseBean {
    ...
    @SerializedName("模具分配分录ID")
    public String moduleSubDirectoryID;
    @SerializedName("模具ID")
    ...
    @SerializedName("养护出库分录ID")
    public String maintenanceOutsubDirectoryID;
