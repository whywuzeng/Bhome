...
public class DingdanSellActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initdate();
        initEvent();
        topfanhuititle_textview_zhende.setText(R.string.dingdanfahuo);
    }

    @Override
    protected String getToolbarTitle() {

        return this.getResources().getString(R.string.dingdanfahuo);
    }
    ...
    private void initEvent() {
        ...
        fanhui_lin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                try {
                    AppManager.getAppManager().finishActivity(DingdanSellActivity.class);
                } catch (Exception e) {
                    e.printStackTrace();
                    if (!DingdanSellActivity.this.isFinishing()) {
                        DingdanSellActivity.this.finish();
                    }
                }
            }
        });
    ...
    private void initdate() {
        String[] stringArray = this.getResources().getStringArray(R.array.dingdanfahuo);
        ...
        for (int i = 0; i < stringArray.length; i++) {
            ...
            if(i%2==0){
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.DingdanSellActivityIndex + "",false);
            }else{
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.DingdanSellActivityIndex + "",true);
