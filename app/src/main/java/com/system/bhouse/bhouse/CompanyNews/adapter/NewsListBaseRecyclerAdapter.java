 ...
 * UpdateDate:<p>
 */
public abstract class NewsListBaseRecyclerAdapter<T> extends RecyclerView.Adapter<BaseRecyclerViewHolder> {
    ...
    public NewsListBaseRecyclerAdapter(Context context, List<T> data) {
        this(context, data, null);
    }

    public NewsListBaseRecyclerAdapter(Context context, List<T> data, RecyclerView.LayoutManager layoutManager) {
        mContext = context;
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_MORE) {
            return new BaseRecyclerViewHolder(mContext, mInflater.inflate(R.layout.common_load_more, parent, false));
            ...
            final BaseRecyclerViewHolder holder = new BaseRecyclerViewHolder(mContext, mInflater.inflate(R.layout.taskcomon_empty_view, parent, false));
