 ...
 * UpdateDate:
 */
public class TransportSendGoodsContentItemSection extends Section {
    ...
    public void setSearchHistroyBeans(ArrayList<TransportSendGoodsBean> searchHistroyBeans) {
        this.searchHistroyBeans = searchHistroyBeans;
    }

    private ArrayList<TransportSendGoodsBean> searchHistroyBeans = new ArrayList<>();


    public TransportSendGoodsContentItemSection(ArrayList<TransportSendGoodsBean> searchHistroyBeans, StatusBean mStatusBean) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            holder1.tvWuliao.setText(searchHistroyBeans.get(position).containerName);
            holder1.tvCount1.setText(searchHistroyBeans.get(position).wareHouseName);
            holder1.tvCount2.setText(searchHistroyBeans.get(position).Qrcode);
            holder1.tvCount.setText(searchHistroyBeans.get(position).materialsNumber);

            holder1.tvUnit.setText(searchHistroyBeans.get(position).materialsNames);
            holder1.tvRequireNum.setText(searchHistroyBeans.get(position).Specification);
            holder1.tvReceiptAmount.setText(searchHistroyBeans.get(position).getMeasureUnit());
            holder1.tvProjectName.setText(searchHistroyBeans.get(position).amount+"");
