...
public class AcceptanceActivity extends BaseActivity {
    ...
    protected String getToolbarTitle() {
        ...
        return this.getResources().getString(R.string.yanshoushengqiu);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initdate();
        initEvent();
        topfanhuititle_textview_zhende.setText(R.string.yanshoushengqiu);
    }
    ...
    private void initdate() {
        ...
        for (int i = 0; i < stringArray.length; i++) {
            ...
            if (i % 2 == 0) {
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.AcceptanceActivityIndex + "", false);
            }
            else {
                fragmentDingdan = FragmentDingdan.newInstance(StatusIndex.AcceptanceActivityIndex + "", true);
