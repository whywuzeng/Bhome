...
//        a.recycle();
        ...
        dividerColor = a.getColor(R.styleable.WechatTab_pstsDividerColorWe, dividerColor);
        indicatorHeight = a.getDimensionPixelSize(R.styleable.WechatTab_pstsIndicatorHeightWe, indicatorHeight);
        underlineHeight = a.getDimensionPixelSize(R.styleable.WechatTab_pstsUnderlineHeightWe, underlineHeight);
        dividerPadding = a.getDimensionPixelSize(R.styleable.WechatTab_pstsDividerPaddingWe, dividerPadding);
        tabPadding = a.getDimensionPixelSize(R.styleable.WechatTab_pstsTabPaddingLeftRightWe, tabPadding);
        tabBackgroundResId = a.getResourceId(R.styleable.WechatTab_pstsTabBackgroundWe, tabBackgroundResId);
