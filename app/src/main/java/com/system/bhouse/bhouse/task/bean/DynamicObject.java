...
import static com.system.bhouse.base.App.getContextApp;
...
//
//
    public static class DynamicTask extends DynamicObject.DynamicBaseObject {
...
//    }
    ...
    public static class Owner implements Serializable {
        ...
        public Owner(JSONObject json) {
            if (json.has("avatar")) {
                avatar = sharedpreferencesuser.getAvator_filefloder(getContextApp());
            }
...
//        }
    ...
    public static class Project implements Serializable {
        public String full_name = "";       //"shouji/ceshiyixia"
        public String name = "";         //"ceshiyixia"
        public String path = "";       //"/u/shouji/p/ceshiyixia"
