...
public class LoadingCarOrderFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        LoadingCarOrderListFragment confirmationReceiptListFragment = new LoadingCarOrderListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Sale_Order_so_Number(getActivity(), new ApiWebService.SuccessCall() {
            ...
            public void SuccessBack(String result) {
                ...
                LoadingCarOrderContentMessageActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
            }
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LoadingCarOrderListFragment fragment = (LoadingCarOrderListFragment) super.instantiateItem(container, position);
            fragment.setParent(LoadingCarOrderFragment.this);
            return fragment;
        }
    }
}
