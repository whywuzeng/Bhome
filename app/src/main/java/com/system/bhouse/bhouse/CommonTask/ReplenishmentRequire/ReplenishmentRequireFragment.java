...
public class ReplenishmentRequireFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        ReplenishmentRequireListFragment confirmationReceiptListFragment = new ReplenishmentRequireListFragment_();
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ReplenishmentRequireListFragment fragment = (ReplenishmentRequireListFragment) super.instantiateItem(container, position);
            fragment.setParent(ReplenishmentRequireFragment.this);
            return fragment;
        }
    }
}
