...
public class MaintainOutWareHouseSectionAdapter extends HeaderAndFooterSectionQuickAdapter<MaintenanceOutWarehouseBeanSection, BaseViewHolder>{
    ...
    public MaintainOutWareHouseSectionAdapter(int layoutResId, int sectionHeadResId, int sectionFooterResId, List data, String[] stringArray, StatusBean statusBean) {
