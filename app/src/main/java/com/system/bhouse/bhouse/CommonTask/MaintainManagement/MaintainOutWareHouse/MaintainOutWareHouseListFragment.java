...
public class MaintainOutWareHouseListFragment extends BaseCommonListFragment<MaintainOutWareHouseLoadingAdapter,MaintenanceOutWarehouseBean> implements MaintainOutWareHouseLoadingAdapter.onItemClickListener {

    MaintainOutWareHouseLoadingAdapter mAdapter;
    ...
    protected Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == REFRESH_DATA) {
                setRefreshing(false);
                ArrayList<MaintenanceOutWarehouseBean> loadedRequires = msg.getData().getParcelableArrayList(LOADEDREQUIREKEY);
    ...
    {
        initRefreshLayout();
        mAdapter = new MaintainOutWareHouseLoadingAdapter(mData);
    ...
    protected void loadData() {
        if (mUpdateAll) {
            mUpdateAll = false;
            ApiWebService.Get_Production_order_yhy_Out_Json(getActivity(), new ApiWebService.SuccessCall() {

                @Override
                public void SuccessBack(String result) {
                    L.e(result);
                    ArrayList<MaintenanceOutWarehouseBean> loadedRequires = App.getAppGson().fromJson(result, new TypeToken<List<MaintenanceOutWarehouseBean>>() {
                    }.getType());
...
//                    taskFragmentLoading(false);
            ...
            }, TextUtils.isEmpty(mLabel) ? 50 : Integer.valueOf(mLabel), TextUtils.isEmpty(mKeyword) ? "" : mKeyword);

//            ApiWebService.Get_Production_order_yhyView_Json(getActivity(), new ApiWebService.SuccessCall() {
//                @Override
//                public void SuccessBack(String result) {
//
//                }
...
//
//                }
//            },"d76c39864d3c4397859e70d008719489");
        }
    ...
    //list Item的点击事件
    @Override
    public void ItemClick(MaintainOutWareHouseLoadingAdapter.ItemViewHolder holder, int position) {
        mNeedUpdate = true;
        ...
        MaintainOutWareHouseContentMessageActivity_.intent(getParentFragment()).HId(mData
