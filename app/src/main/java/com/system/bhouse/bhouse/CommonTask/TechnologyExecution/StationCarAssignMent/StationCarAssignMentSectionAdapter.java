...
public class StationCarAssignMentSectionAdapter extends HeaderAndFooterSectionQuickAdapter<StationCarAssignMentBeanSection, BaseViewHolder>{
    ...
    public StationCarAssignMentSectionAdapter(int layoutResId, int sectionHeadResId, int sectionFooterResId, List data, String[] stringArray, StatusBean statusBean) {
    ...
    @Override
    protected void convertHead(BaseViewHolder helper, StationCarAssignMentBeanSection item) {

    }

    @Override
    protected void converFooter(BaseViewHolder helper, StationCarAssignMentBeanSection item) {
        helper.setVisible(R.id.btn_addItem, false);
        helper.addOnClickListener(R.id.btn_addItem);
    }

    @Override
    protected void convert(BaseViewHolder helper, StationCarAssignMentBeanSection item) {
     ...
     */
    private void initDataForView(BaseAssignViewHolder moduleAssignViewHolder, StationCarAssignMentBeanSection item) {
        ...
        contvs.get(9).setText(item.t.productionLineName);
        contvs.get(10).setText(item.t.number+"");
