...
public class MaintenanceWarehouseSectionAdapter extends HeaderAndFooterSectionQuickAdapter<MaintenanceWarehouseBeanSection, BaseViewHolder>{
    ...
    public MaintenanceWarehouseSectionAdapter(int layoutResId, int sectionHeadResId, int sectionFooterResId, List data, String[] stringArray, StatusBean statusBean) {
