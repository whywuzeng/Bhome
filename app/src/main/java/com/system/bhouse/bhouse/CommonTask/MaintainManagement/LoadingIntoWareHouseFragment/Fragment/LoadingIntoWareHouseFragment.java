...
public class LoadingIntoWareHouseFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        ...
        LoadingIntoWareHouseListFragment confirmationReceiptListFragment = new LoadingIntoWareHouseListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Production_order_Container_po_Number(getActivity(), new ApiWebService.SuccessCall() {
            @Override
...
//                LoadingIntoWareHouseContentActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            LoadingIntoWareHouseListFragment fragment = (LoadingIntoWareHouseListFragment) super.instantiateItem(container, position);
            fragment.setParent(LoadingIntoWareHouseFragment.this);
            return fragment;
        }
    }
}
