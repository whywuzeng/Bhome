 ...
 * by author wz
 * <p>
 * com.system.bhouse.bhouse.CommonTask.utils
 */


public class ComTaskContentItemSectionItemTouchHelper extends ItemTouchHelper.Callback {
    ItemTouchAdapterImpl adapter;

    public ComTaskContentItemSectionItemTouchHelper(@NonNull ItemTouchAdapterImpl adapter) {
    ...
    // 建议让 adapter 实现该接口
    public static abstract class ItemTouchAdapterImpl extends SectionedRecyclerViewAdapter {
