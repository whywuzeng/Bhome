...
public class MaintainIntoWareHouseFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        MaintainIntoWareHouseListFragment confirmationReceiptListFragment = new MaintainIntoWareHouseListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Production_order_yhy_Inpo_Number(getActivity(), new ApiWebService.SuccessCall() {
            @Override
            public void SuccessBack(String result) {
                ...
                MaintainIntoWareHouseContentMessageActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
            }
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            MaintainIntoWareHouseListFragment fragment = (MaintainIntoWareHouseListFragment) super.instantiateItem(container, position);
            fragment.setParent(MaintainIntoWareHouseFragment.this);
            return fragment;
        }
    }
}
