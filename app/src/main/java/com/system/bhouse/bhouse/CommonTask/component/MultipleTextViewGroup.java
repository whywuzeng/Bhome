...
public class MultipleTextViewGroup extends RelativeLayout {
    ...
    public MultipleTextViewGroup(Context context, AttributeSet attrs) {
        ...
        textColor = array.getColor(R.styleable.MultipleTextViewGroup_textColor, 0XFF4b4b4b); // 提供默认值，放置未指定
    ...
    private void setTextViewsTrue(List<String> dataList) {
        ...
        for (int i = 0; i < dataList.size(); i++) {
            ...
            if (dataList.get(i).endsWith(":")||x + tvw > layout_width || lineMap.get(line).size() >= columnNum) {
                x = 0;
                y = y + tvh + lineMargin-10;
