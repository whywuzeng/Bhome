 ...
 * UpdateDate:
 */
public class ReplenishmentRequireContentItemSection extends Section {
    ...
    public ReplenishmentRequireContentItemSection(ArrayList<ConfirmationReceBean> searchHistroyBeans, StatusBean mStatusBean) {
    ...
    public void onBindItemViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof ViewHolder) {
            ...
            holder1.tvCengAmount.setText(searchHistroyBeans.get(position).qualityType);
...
//            holder1.tvReceiptAmountId, 项目名称前
            TextView[] titleContent = { holder1.tvWuliaoId, holder1.tvCountMeasureId, holder1.tvCountAmountId, holder1.tvCountId,holder1.tvUnitId,holder1.tvRequireNumId,holder1.tvReceiptAmountId,holder1.tvProjectNameId,holder1.tvDongId,holder1.tvCengAmountId};
