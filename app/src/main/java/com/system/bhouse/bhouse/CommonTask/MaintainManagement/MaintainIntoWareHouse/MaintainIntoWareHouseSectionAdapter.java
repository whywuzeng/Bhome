...
public class MaintainIntoWareHouseSectionAdapter extends HeaderAndFooterSectionQuickAdapter<MaintenanceWarehouseBeanSection, BaseViewHolder>{
    ...
    public MaintainIntoWareHouseSectionAdapter(int layoutResId, int sectionHeadResId, int sectionFooterResId, List data, String[] stringArray, StatusBean statusBean) {
    ...
    @Override
    protected void convertHead(BaseViewHolder helper, MaintenanceWarehouseBeanSection item) {

    }

    @Override
    protected void converFooter(BaseViewHolder helper, MaintenanceWarehouseBeanSection item) {
        helper.setVisible(R.id.btn_addItem, false);
        helper.addOnClickListener(R.id.btn_addItem);
    }

    @Override
    protected void convert(BaseViewHolder helper, MaintenanceWarehouseBeanSection item) {
     ...
     */
    private void initDataForView(BaseAssignViewHolder moduleAssignViewHolder, MaintenanceWarehouseBeanSection item) {
