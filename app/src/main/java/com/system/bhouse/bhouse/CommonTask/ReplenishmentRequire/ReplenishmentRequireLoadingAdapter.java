...
public class ReplenishmentRequireLoadingAdapter extends LoadingAdapter<ConfirmationReceBean> {

    private ArrayList<ConfirmationReceBean> mComTaskBeans = new ArrayList<>();

    public ReplenishmentRequireLoadingAdapter(ArrayList<ConfirmationReceBean> mComTaskBeans) {
