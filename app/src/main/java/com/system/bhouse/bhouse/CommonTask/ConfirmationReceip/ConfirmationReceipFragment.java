...
public class ConfirmationReceipFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        ConfirmationReceipListFragment confirmationReceiptListFragment = new ConfirmationReceipListFragment_();
    ...
    protected void AddIntentFor() {
        ...
        ApiWebService.Get_Sale_Order_Car_qr_so_Number(getActivity(), new ApiWebService.SuccessCall() {
            ...
            public void SuccessBack(String result) {
                ...
                ConfirmationContentMessageActivity_.intent(getActivity()).HId("").receiptHnumber(result).mStatus(statusBean).start();
            }
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ConfirmationReceipListFragment fragment = (ConfirmationReceipListFragment) super.instantiateItem(container, position);
            fragment.setParent(ConfirmationReceipFragment.this);
            return fragment;
        }
    }
}
