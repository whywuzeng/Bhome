...
public class ContainerRecycleLoadingAdapter extends LoadingAdapter<ContainerRecycleBean> {

    private ArrayList<ContainerRecycleBean> mComTaskBeans = new ArrayList<>();

    public ContainerRecycleLoadingAdapter(ArrayList<ContainerRecycleBean> mComTaskBeans) {
...
// .get(position).getID() + "").IsNew(false).start();
    ...
    private List<String> getListStrings(int position) {
        ...
        dataList.add("货柜:");
        dataList.add(mComTaskBeans
                .get(position).getContainer() == null ? "" : mComTaskBeans
                .get(position).getContainer());
