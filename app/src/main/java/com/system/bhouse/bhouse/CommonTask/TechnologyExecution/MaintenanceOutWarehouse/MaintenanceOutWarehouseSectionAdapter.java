...
public class MaintenanceOutWarehouseSectionAdapter extends HeaderAndFooterSectionQuickAdapter<MaintenanceOutWarehouseBeanSection, BaseViewHolder>{
    ...
    public MaintenanceOutWarehouseSectionAdapter(int layoutResId, int sectionHeadResId, int sectionFooterResId, List data, String[] stringArray, StatusBean statusBean) {
    ...
    @Override
    protected void convertHead(BaseViewHolder helper, MaintenanceOutWarehouseBeanSection item) {

    }

    @Override
    protected void converFooter(BaseViewHolder helper, MaintenanceOutWarehouseBeanSection item) {
        helper.setVisible(R.id.btn_addItem, false);
        helper.addOnClickListener(R.id.btn_addItem);
    }

    @Override
    protected void convert(BaseViewHolder helper, MaintenanceOutWarehouseBeanSection item) {
     ...
     */
    private void initDataForView(BaseAssignViewHolder moduleAssignViewHolder, MaintenanceOutWarehouseBeanSection item) {
