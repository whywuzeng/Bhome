...
import static com.system.bhouse.Common.Global.dayFromTime;
import static com.system.bhouse.base.Global.*;
...
//    };
    ...
    private void dateSet(int year, int monthOfYear, int dayOfMonth) {
        ...
        if (mDateSet != null) {
            mDateSet.dateSetResult(dayFromTime(c.getTimeInMillis()), false);
        }
    }
