 ...
 * UpdateDate:
 */
public class ReturnRequireContentItemSection extends Section {
    ...
    public ReturnRequireContentItemSection(ArrayList<ConfirmationReceBean> searchHistroyBeans, StatusBean mStatusBean) {
...
//            holder1.tvReceiptAmountId, 项目名称前
            TextView[] titleContent = { holder1.tvWuliaoId, holder1.tvCountMeasureId, holder1.tvCountAmountId, holder1.tvCountId,holder1.tvUnitId,holder1.tvRequireNumId,holder1.tvProjectNameId,holder1.tvDongId,holder1.tvCengAmountId};
