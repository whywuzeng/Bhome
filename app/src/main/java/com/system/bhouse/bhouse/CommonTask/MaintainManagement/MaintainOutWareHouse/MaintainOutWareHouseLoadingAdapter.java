...
public class MaintainOutWareHouseLoadingAdapter extends LoadingAdapter<MaintenanceOutWarehouseBean> {

    private final String[] TitlestringArray;
    private ArrayList<MaintenanceOutWarehouseBean> mComTaskBeans = new ArrayList<>();

    public MaintainOutWareHouseLoadingAdapter(ArrayList<MaintenanceOutWarehouseBean> mComTaskBeans) {
        this.mComTaskBeans = mComTaskBeans;
        TitlestringArray = App.getContextApp().getResources().getStringArray(R.array.maintainout_warehouse);
    }
