...
public class ComponentReturnsFragment extends BaseCommonFragment implements TaskListParentUpdate {
    ...
    void initConfirmationReceiptFragment(){
        initPagerView();
        ComponentReturnsListFragment confirmationReceiptListFragment = new ComponentReturnsListFragment_();
    ...
    protected class ConfirmationPageTaskFragment extends PageTaskFragment {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            ComponentReturnsListFragment fragment = (ComponentReturnsListFragment) super.instantiateItem(container, position);
            fragment.setParent(ComponentReturnsFragment.this);
            return fragment;
        }
    }
}
