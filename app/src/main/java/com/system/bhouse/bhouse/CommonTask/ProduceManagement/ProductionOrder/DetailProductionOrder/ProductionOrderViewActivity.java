...
import com.system.bhouse.bhouse.CommonTask.ProduceManagement.ProductionOrder.ProductionOrderContentItemSection;
...
public class ProductionOrderViewActivity extends WWBackActivity implements ProductionOrderContentItemSection.OnItemClickListener, GroupItem.onChildItemClickListener, onMutiDataSetListener {
    ...
    public void initComTaskActivity() {
        if (mStatus.isNewStatus()) {
            ...
            setActionBarMidlleTitle("生产清单");
        }
        tv_title_live_layout.setText("生产清单分录");
