...
public class FinishedStorageContentMessageActivity extends BaseContentMessageActivity implements FinishedStorageContentItemSection.OnItemClickListener, GroupItem.onChildItemClickListener, onMutiDataSetListener {
    ...
    private void TopListViewInit() {
        ...
        if (ValueUtils.IsFirstValueExist(comTaskBeans)) {
            ...
            comTaskBean1=new FinishedStorageBean();
