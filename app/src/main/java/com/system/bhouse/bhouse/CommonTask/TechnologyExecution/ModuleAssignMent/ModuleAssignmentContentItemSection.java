 ...
 * UpdateDate:
 */
public class ModuleAssignmentContentItemSection extends Section {
    ...
    public ArrayList<ModuleAssignmentBean> getSearchHistroyBeans() {
        return searchHistroyBeans;
    }

    public ModuleAssignmentBean getSearchHistroyBeans(int position) {
        ModuleAssignmentBean ModuleAssignmentBean = searchHistroyBeans.get(position);
        return ModuleAssignmentBean;
    }

    private ArrayList<ModuleAssignmentBean> searchHistroyBeans;


    public ModuleAssignmentContentItemSection(ArrayList<ModuleAssignmentBean> searchHistroyBeans, StatusBean mStatusBean) {
    ...
    private void initDataForView(ViewHolder holder1, int position) {
        ...
        contvs.get(0).setText(searchHistroyBeans.get(position).materialCoding);
        contvs.get(1).setText(searchHistroyBeans.get(position).Qrcode);
        contvs.get(2).setText(searchHistroyBeans.get(position).materialName);
        ...
        contvs.get(5).setText(searchHistroyBeans.get(position).startTime);
        contvs.get(6).setText(searchHistroyBeans.get(position).endTime);
        contvs.get(7).setText(searchHistroyBeans.get(position).moduleName);
        contvs.get(8).setText(searchHistroyBeans.get(position).number+"");
